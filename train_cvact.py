...
if __name__ == '__main__':
    ...
    print_dist("Reference Images Val: " + str(len(reference_dataset_val)), LOCAL_RANK)
    print_dist("Query Images Val: " + str(len(query_dataset_val)), LOCAL_RANK)
    
    
    #-----------------------------------------------------------------------------#
    # GPS Sample                                                                  #
    #-----------------------------------------------------------------------------#
    if config.gps_sample and LOCAL_RANK < 1:
